...
namespace SkyLens2
{
    public class ConstellationService
    {
        ...
        {
            var constellations = new ConcurrentBag<Constellation>();
            ...
            try
            {
                ...
                // Parallel parsing of JSON fields
                Parallel.ForEach(results.EnumerateArray(), fields =>
                {
                    try
                    {
                    ...
                    {
                        Console.WriteLine($"rror parsing field entry: {e.Message}");
                    }
                });
            ...
            return new List<Constellation>(constellations);
        }
    }
}